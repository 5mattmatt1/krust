...
// ChipCmdBits
const CmdReset: u32 = 0x10;
const CmdRxEnb: u32 = 0x08;
const CmdTxEnb: u32 = 0x04;
const RxBufEmpty: u32 = 0x01;
// IntrStatusBits
...
pub unsafe fn reset(ioaddr: u32) -> bool
{
    ...
    asm::outl(CmdReset, reset_address);
    cmd_offset = asm::inl(reset_address);
    // inb(ioaddr + CMD_OFFSET) & 0x10) != 0
    // serial_println!("CMD_OFFSET: {}", cmd_offset);
    return ((cmd_offset) & CmdReset) == 0;
}
